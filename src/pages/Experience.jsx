function Experience() {
  return (
    // flex items-center justify-center desktop:pt-20 mobile:py-9 desktop:px-8 tablet:px-5 mobile:px-3
    <div className="desktop:pt-20 mobile:py-9 desktop:px-8 tablet:px-5 mobile:px-3">
      {/* flex desktop:gap-14 mobile:gap-5 items-center desktop:w-[1240px]
      tablet:w-[768px] mobile:w-[320px] mx-auto */}
      <div
      ...
      >
        ...
        <ul>
          <li className="flex flex-col gap-2">
            ...
            <span className="desktop:text-base tablet:text-sm mobile:text-xs">
              2023. 05 ~ 2023. 09
            </span>
          </li>
        </ul>
