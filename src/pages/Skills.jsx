...
function Skills() {
  return (
    ...
    //     <h2 className="desktop:text-5xl tablet:text-3xl mobile:text-xl font-semibold font-gm">
    //       Skills
    //     </h2>
    ...
    // </div>
    <div className="desktop:px-8 desktop:py-24 tablet:py-16 mobile:py-9 flex items-center justify-center ">
      <div className="desktop:w-[1240px] tablet:w-[768px] mobile:w-[320px] mx-auto flex flex-col">
        <h2 className="desktop:text-5xl tablet:text-3xl mobile:text-xl font-semibold font-gm text-white">
          Skills
        </h2>
        <div className="w-[90%] flex flex-col">
          <div className="flex flex-col gap-10 rounded-2xl">
            <ul className="flex desktop:gap-7  mobile:gap-5 desktop:text-lg mobile:text-base font-medium">
              <li className="flex flex-col items-start bg-[#3a3e41]">
                <img
                  className="desktop:w-24 mobile:w-16"
                  src={react}
                  alt="react 이미지"
              ...
              <li className="flex flex-col items-start">
                ...
                <span>TailwindCSS</span>
                <p>
                  다양한 레이아웃을 활용해 반응형 웹 디자인을 할 수 있습니다.
                </p>
              </li>
