  ...
  return (
    <div className="border-t-2 border-t-black mb-40">
      ...
      <div className="flex justify-around">
        <motion.div
          className="flex flex-col gap-10 items-center shadow-xl py-10 px-20 rounded-2xl"
          whileHover={{ y: -15 }}
          transition={{
            type: "tween",
            stiffness: 300,
        ...
        <motion.div
          className="flex flex-col gap-10 items-center shadow-xl py-10 px-16 h-[60vh] rounded-2xl"
          whileHover={{ y: -15 }}
          transition={{
            type: "tween",
            stiffness: 300,
