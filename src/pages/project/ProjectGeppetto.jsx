                ...
                <div className="px-5 py-5 flex flex-col gap-12">
                  ...
                  <div>
                    ...
                    <p className="mt-2">
                      ...
                      이 있는데 디바운싱은 이벤트가 계속 발생할 때 맨 마지막
                      이벤트만 발생하도록 하는 것입니다. 따라서 input에 입력하는
                      행위를 할때는 디바운싱이 적합합니다. 쓰로틀링은 이벤트가
                      발생하는 주기를 정하고 주기를 벗어나면 그동안은 이벤트가
                      일어나지 않는 것입니다. 쓰로틀링은 무한스크롤과 같은
                      행위를 할때 적합합니다.
                    </p>
                  </div>
                </div>
